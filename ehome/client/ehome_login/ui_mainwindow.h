...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tabWidget->setGeometry(QRect(20, 40, 681, 444));
        tab = new QWidget();
        ...
        layoutWidget->setGeometry(QRect(30, 120, 414, 80));
        ...
        getTempBtn = new QPushButton(layoutWidget);
        ...
        temperatureTB = new QTextBrowser(layoutWidget);
        temperatureTB->setObjectName(QString::fromUtf8("temperatureTB"));
        temperatureTB->setMaximumSize(QSize(256, 192));
        ...
        layoutWidget2->setGeometry(QRect(10, 20, 520, 33));
        horizontalLayout_2 = new QHBoxLayout(layoutWidget2);
        horizontalLayout_2->setObjectName(QString::fromUtf8("horizontalLayout_2"));
        horizontalLayout_2->setContentsMargins(0, 0, 0, 0);
        systemInfoBtn = new QPushButton(layoutWidget2);
        ...
        layoutWidget4->setGeometry(QRect(20, 130, 571, 20));
        ...
        hwVersionLabel = new QLabel(layoutWidget4);
        ...
        swVersionLabel = new QLabel(layoutWidget4);
