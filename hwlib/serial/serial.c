...
/* ??linux?ں???,struct ktermios?ṹ??c_cflags????5??λ??��??ע??????,????λCBAUDEX????ʹ?õ???POSIX??׼?????ʻ???��չ??????,
POSIX?涨??16????׼??????,ΪB0,B50,B75,B110,B134,B150,B200,B300,B600,B1200,B1800,B2400,B4800,B9600,B19200,B38400*/
