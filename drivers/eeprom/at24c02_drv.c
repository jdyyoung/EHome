...
#define I2C_READ    0x100008
#define I2C_WRITE   0x100009
...
static int at24c02_ioctl(   struct file *file,
                            unsigned int cmd,
                            unsigned long arg)
{
...
{
    //1.注册混杂设备驱动
    if(0 == misc_register(&at24c02_dev))
    {
...
{
    //注册i2c_driver
    if(0 == i2c_add_driver(&at24c02_drv) )
    {
        printk("__func__\n");
    }
    return 0;
